...
const perguntas = [
    {
        enunciado: "Você acha que o homem altera muito a natureza?",
        alternativas: [
            {
                texto: "sim",
                afirmacao: "afirmação"
    ...
    {
        enunciado: "Quais os principais causadores do aquecimento global?",
        alternativas: [
            {
                texto: "Fábricas, derrubada de floresta,transportes,produção de alimento",
                afirmacao: "afirmação"
            },
            {
                texto: "luz solar, animais e plantios",
                afirmacao: "afirmação"
            }
        ]
    },
